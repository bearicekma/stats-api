...
# e-Stat APIをページネーションで取得しコードを名称に変換して返す
# Claude・Firestoreは使わないので費用ゼロ
# 例: /estat/pass/0003427113?areas=00000,13A01,20A01
# 例: /estat/pass/0003427113?areas=00000,13A01,20A01&time_from=2020000000&time_to=2024000000&limit=5000
@app.get("/estat/pass/{stats_data_id}")
async def estat_pass(
    stats_data_id: str,
    limit:     int = 1000,  # デフォルト1000件
    ...
    return {
        ...
        "total_number":  total_number,      # e-Stat上の総件数（絞り込み後）
